...
//	},
	...
	getiOrderUrl: function(){
		return  "https://miorders4dev.cpf.co.th/mobile/index.html?sap-ui-appcache=false&sap-ui-language=TH" +
		  "&prot-version=2" 						+
		  "&uuid="  + oCon.getControl("v002.inpUUID").getValue() +
		  "&guid="  + oCon.getControl("v002.inpGuid").getValue() +
	...
	getModelURL: function(action){
		...
		return "https://miorders4dev.cpf.co.th/zui5?prot-version=2&application=mobi01&action=" + action;
	},
